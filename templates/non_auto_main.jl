...
function main()
    ...
    if startswith(explorer_type, "RWMH")
        step_size = if model == "logearn_logheight_male"
            0.017440022362658205
        elseif model == "diamonds"
            0.001994331112338999
        elseif model == "kilpisjarvi"
            0.007869168935695043
        elseif model == "mRNA"
        ...
        estimated_target_std_deviations = if model == "logearn_logheight_male"
            [1.3090467025338774, 0.31429282715279794, 0.058613031904474894, 0.020410925101622204]
        elseif model == "diamonds"
            [0.38554830446919724, 1.0181743791429372, 0.8971432431392055, 0.23805261452425738, 0.0074882056987033456, 0.006550571092531772, 0.005933383811630033, 0.004598145642334496, 0.006022426145728062, 0.005602128934030007, 0.005294850960153855, 0.004866234795107343, 0.004616400504150112, 0.004271870174788096, 0.011284791171147312, 0.01068882133566514, 0.009081000225829727, 0.007031899521552864, 0.005809120496287298, 0.005057908857479898, 0.004432261194636604, 1.0929323934824378, 0.916506350922348, 0.17033578104399794, 0.0017510743842540076, 0.013122780979024683]
        elseif model == "kilpisjarvi"
            [29.731615341144032, 0.0074654299263231, 0.0939452394450459]
        elseif model == "mRNA"
    ...
    elseif startswith(explorer_type, "MALA")
        step_size = if model == "logearn_logheight_male"
            0.016699347164235344
        elseif model == "diamonds"
            0.003163661730404864
        elseif model == "kilpisjarvi"
            0.005699011719323586
        elseif model == "mRNA"
        ...
        estimated_target_std_deviations = if model == "logearn_logheight_male"
            [1.6898382142173114, 0.40565819946676884, 0.062147070776689115, 0.02042580864328038]
        elseif model == "diamonds"
            [0.18579134989549867, 0.4618161338314826, 0.4881396219768215, 0.0764786141437677, 0.007411855533445826, 0.006491474063611595, 0.0056053052053163365, 0.004553295825698682, 0.0061391537897447085, 0.0057204862296606155, 0.005189144777560669, 0.004844974406327408, 0.004518432129891094, 0.004279733240865146, 0.010902323608912032, 0.010326336564658457, 0.0088821854640584, 0.007068117892949183, 0.005557059284844456, 0.004955511648052, 0.004366029151673206, 0.4601327046880028, 0.3955400122249159, 0.05081212190360148, 0.0017607655752827217, 0.010760760400286274]
        elseif model == "kilpisjarvi"
            [17.712886801475882, 0.00444773586803505, 0.07854259373938016]
        elseif model == "mRNA"
    ...
    elseif startswith(explorer_type, "HMC")
        step_size = if model == "logearn_logheight_male"
            0.01514050888387312
        elseif model == "diamonds"
            0.0034203045269659347
        elseif model == "kilpisjarvi"
            0.0030527657877695165
        elseif model == "mRNA"
        ...
        estimated_target_std_deviations = if model == "logearn_logheight_male"
            [2.6064216532743756, 0.6254768056021733, 0.07164471778676394, 0.02051124155578566]
        elseif model == "diamonds"
            [0.2574712604606455, 0.24123254461568902, 0.24294572052024227, 0.13131992188861966, 0.007395713605795647, 0.0064462756147389035, 0.0056359043719174115, 0.004430181097432092, 0.006108426436404136, 0.005541992670291924, 0.005195153757012634, 0.004780135521217787, 0.00455204273720226, 0.004182502811914421, 0.011187905066029114, 0.010527649649197559, 0.009037943742377121, 0.0070440794152826025, 0.0056782736973817775, 0.0049201058888450385, 0.004333891597829034, 0.21983305752285928, 0.2551551951872881, 0.18413051491029023, 0.00175024512394599, 0.010137000474376654]
        elseif model == "kilpisjarvi"
            [37.25727246646965, 0.009355147784826118, 0.10691128954671046]
        elseif model == "mRNA"
